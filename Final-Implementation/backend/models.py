...
class PaymentTransaction(Base):
    ...
    clinical_screening_reasons = Column(JSON, nullable=True)
    financial_screening_reason = Column(String, nullable=True)
    financial_screening_notes = Column(Text, nullable=True)
    financial_screening_completed = Column(Boolean, default=False)
...
class SOSYSLegacyLog(Base):
    ...
    gateway_ref_id = Column(String, nullable=True)
    ...
    notes = Column(Text, nullable=True)
    clinical_difference = Column(Float, default=0.0)
    financial_difference = Column(Float, default=0.0)
    total_difference = Column(Float, default=0.0)
    clinical_reasons = Column(JSON, nullable=True)
    financial_reason = Column(String, nullable=True)
