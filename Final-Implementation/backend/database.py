...
def sync_demo_schema():
    ...
    additions = {
        ...
        "payment_transactions": {
            ...
            "paid_amount": "FLOAT",
            "clinical_screening_reasons": "JSON",
            "financial_screening_reason": "VARCHAR",
            "financial_screening_notes": "TEXT",
            "financial_screening_completed": "BOOLEAN DEFAULT 0",
        },
        "sosys_legacy_logs": {
            "batch_id": "VARCHAR",
            "batch_code": "VARCHAR",
            ...
            "approved_amount": "FLOAT",
            "paid_amount": "FLOAT",
            "clinical_difference": "FLOAT DEFAULT 0",
            "financial_difference": "FLOAT DEFAULT 0",
            "total_difference": "FLOAT DEFAULT 0",
            "clinical_reasons": "JSON",
            "financial_reason": "VARCHAR",
