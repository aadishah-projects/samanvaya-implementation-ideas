    ...
    if processed_claims:
        ...
        for claim in processed_claims:
            db.add(PaymentTransaction(
                ...
                clinical_screening_reasons=[] if claim.approved_amount >= claim.claimed_amount else ["Historical clinical adjustment"],
                financial_screening_reason="No financial difference",
                financial_screening_completed=True,
